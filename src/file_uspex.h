...
/*4.13 Seldom*/
	...
	gint 		*softMutOnly;		/*generations that are produced by softmutation*/
...
/*5.5 Particle swarm optimization*/
	...
	gdouble		PSO_BestStruct;		/*weight of heredity with best position, within same PSO particle*/
...
/*6.2 VC-NEB options*/
	...
	gint 		_vcnebtype_img_num;	/*HIDDEN: .X. digit in vcnebType: fixed or variable image number*/
	gint 		_vcnebtype_spring;	/*HIDDEN: ..X digit in vcnebType: fixed or variable spring constant*/
	...
	gdouble		VarPathLenght;		/*min distance (* 1.5) between 2 image to generate a new image*/
